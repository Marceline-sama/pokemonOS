...
def scrape_pokemon_data(url):
    ...
    if response.status_code == 200:
        ...
        # Gênero
        gender = soup.find('span', class_='pokemon-gender').text.strip()
        pokemon_data['gender'] = gender

        # Status
        stats = soup.find_all('div', class_='pokemon-stat')
        pokemon_stats = {}
        for stat in stats:
        ...
        # Forças e Fraquezas
        strengths = soup.find('div', class_='pokemon-strengths').find_all('span', class_='type-icon')
        weaknesses = soup.find('div', class_='pokemon-weaknesses').find_all('span', class_='type-icon')
        ...
        # Lista de Ataques
        moves = soup.find_all('div', class_='move-info')
        move_list = []
        for move in moves:
            move_name = move.find('span', class_='move-name').text.strip()
            move_type = move.find('span', class_='move-type').text.strip()
            move_list.append({
                'name': move_name,
                'type': move_type
            })
        ...
        pokedex_entries = soup.find_all('div', class_='pokedex-entry')
        descriptions = {}
        for entry in pokedex_entries:
            pokedex_name = entry.find('h3').text.strip()
            description = entry.find('p').text.strip()
            descriptions[pokedex_name] = description
        pokemon_data['descriptions'] = descriptions

        # Imagem do Pokémon
        img_url = soup.find('div', class_='pokemon-sprite').find('img')['src']
...
pokemon_links = [
    ...
    "https://pokemondb.net/pokedex/raichu",
    "https://pokemondb.net/pokedex/sandshrew",
    "https://pokemondb.net/pokedex/sandslash",
    ...
    "https://pokemondb.net/pokedex/zubat",
    "https://pokemondb.net/pokedex/golbat",
    "https://pokemondb.net/pokedex/oddish",
    "https://pokemondb.net/pokedex/gloom",
    "https://pokemondb.net/pokedex/vileplume",
    "https://pokemondb.net/pokedex/paras",
    "https://pokemondb.net/pokedex/parasect",
    "https://pokemondb.net/pokedex/venonat",
    "https://pokemondb.net/pokedex/venomoth",
    ...
    "https://pokemondb.net/pokedex/mankey",
    "https://pokemondb.net/pokedex/primeape",
    "https://pokemondb.net/pokedex/growlithe",
    ...
    "https://pokemondb.net/pokedex/abra",
    "https://pokemondb.net/pokedex/kadabra",
    "https://pokemondb.net/pokedex/alakazam",
    "https://pokemondb.net/pokedex/machop",
    "https://pokemondb.net/pokedex/machoke",
    ...
    "https://pokemondb.net/pokedex/tentacool",
    "https://pokemondb.net/pokedex/tentacruel",
    "https://pokemondb.net/pokedex/geodude",
    "https://pokemondb.net/pokedex/graveler",
    "https://pokemondb.net/pokedex/golem",
    "https://pokemondb.net/pokedex/ponyta",
    "https://pokemondb.net/pokedex/rapidash",
    ...
    "https://pokemondb.net/pokedex/doduo",
    "https://pokemondb.net/pokedex/dodrio",
    "https://pokemondb.net/pokedex/seel",
    "https://pokemondb.net/pokedex/dewgong",
    "https://pokemondb.net/pokedex/grimer",
    "https://pokemondb.net/pokedex/muk",
    "https://pokemondb.net/pokedex/shellder",
    "https://pokemondb.net/pokedex/cloyster",
    ...
    "https://pokemondb.net/pokedex/drowzee",
    "https://pokemondb.net/pokedex/hypno",
    "https://pokemondb.net/pokedex/krabby",
    "https://pokemondb.net/pokedex/kingler",
    "https://pokemondb.net/pokedex/voltorb",
    "https://pokemondb.net/pokedex/electrode",
    "https://pokemondb.net/pokedex/exeggcute",
    "https://pokemondb.net/pokedex/exeggutor",
    ...
    "https://pokemondb.net/pokedex/rhyhorn",
    "https://pokemondb.net/pokedex/rhydon",
    "https://pokemondb.net/pokedex/chansey",
    "https://pokemondb.net/pokedex/tangela",
    "https://pokemondb.net/pokedex/kangaskhan",
    "https://pokemondb.net/pokedex/horsea",
    "https://pokemondb.net/pokedex/seadra",
    "https://pokemondb.net/pokedex/goldeen",
    "https://pokemondb.net/pokedex/seaking",
    "https://pokemondb.net/pokedex/staryu",
    "https://pokemondb.net/pokedex/starmie",
    "https://pokemondb.net/pokedex/mr-mime",
    "https://pokemondb.net/pokedex/scyther",
    "https://pokemondb.net/pokedex/jynx",
    "https://pokemondb.net/pokedex/electabuzz",
    "https://pokemondb.net/pokedex/magmar",
    "https://pokemondb.net/pokedex/pinsir",
    "https://pokemondb.net/pokedex/tauros",
    "https://pokemondb.net/pokedex/magikarp",
    "https://pokemondb.net/pokedex/gyarados",
    "https://pokemondb.net/pokedex/lapras",
    "https://pokemondb.net/pokedex/ditto",
    "https://pokemondb.net/pokedex/eevee",
    "https://pokemondb.net/pokedex/vaporeon",
    "https://pokemondb.net/pokedex/jolteon",
    ...
    "https://pokemondb.net/pokedex/zapdos",
    "https://pokemondb.net/pokedex/moltres",
    "https://pokemondb.net/pokedex/dratini",
    "https://pokemondb.net/pokedex/dragonair",
    ...
    "https://pokemondb.net/pokedex/bayleef",
    "https://pokemondb.net/pokedex/meganium",
    "https://pokemondb.net/pokedex/cyndaquil",
    "https://pokemondb.net/pokedex/quilava",
    "https://pokemondb.net/pokedex/typhlosion",
    "https://pokemondb.net/pokedex/totodile",
    "https://pokemondb.net/pokedex/croconaw",
    "https://pokemondb.net/pokedex/feraligatr",
    "https://pokemondb.net/pokedex/sentret",
    "https://pokemondb.net/pokedex/furret",
    "https://pokemondb.net/pokedex/hoothoot",
    "https://pokemondb.net/pokedex/noctowl",
    "https://pokemondb.net/pokedex/ledyba",
    "https://pokemondb.net/pokedex/ledian",
    "https://pokemondb.net/pokedex/spinarak",
    "https://pokemondb.net/pokedex/ariados",
    "https://pokemondb.net/pokedex/crobat",
    "https://pokemondb.net/pokedex/chinchou",
    "https://pokemondb.net/pokedex/lanturn",
    ...
    "https://pokemondb.net/pokedex/natu",
    "https://pokemondb.net/pokedex/xatu",
    "https://pokemondb.net/pokedex/mareep",
    "https://pokemondb.net/pokedex/flaaffy",
    "https://pokemondb.net/pokedex/ampharos",
    "https://pokemondb.net/pokedex/bellossom",
    "https://pokemondb.net/pokedex/marill",
    "https://pokemondb.net/pokedex/azumarill",
    "https://pokemondb.net/pokedex/sudowoodo",
    "https://pokemondb.net/pokedex/politoed",
    "https://pokemondb.net/pokedex/hoppip",
    "https://pokemondb.net/pokedex/skiploom",
    "https://pokemondb.net/pokedex/jumpluff",
    "https://pokemondb.net/pokedex/aipom",
    "https://pokemondb.net/pokedex/sunkern",
    "https://pokemondb.net/pokedex/sunflora",
    "https://pokemondb.net/pokedex/yanma",
    "https://pokemondb.net/pokedex/wooper",
    "https://pokemondb.net/pokedex/quagsire",
    ...
    "https://pokemondb.net/pokedex/misdreavus",
    "https://pokemondb.net/pokedex/unown",
    ...
    "https://pokemondb.net/pokedex/gligar",
    "https://pokemondb.net/pokedex/steelix",
    "https://pokemondb.net/pokedex/snubbull",
    "https://pokemondb.net/pokedex/granbull",
    "https://pokemondb.net/pokedex/qwilfish",
    "https://pokemondb.net/pokedex/scizor",
    "https://pokemondb.net/pokedex/shuckle",
    "https://pokemondb.net/pokedex/heracross",
    "https://pokemondb.net/pokedex/sneasel",
    ...
    "https://pokemondb.net/pokedex/corsola",
    "https://pokemondb.net/pokedex/remoraid",
    "https://pokemondb.net/pokedex/octillery",
    "https://pokemondb.net/pokedex/delibird",
    "https://pokemondb.net/pokedex/mantine",
    "https://pokemondb.net/pokedex/skarmory",
    "https://pokemondb.net/pokedex/houndour",
    "https://pokemondb.net/pokedex/houndoom",
    "https://pokemondb.net/pokedex/kingdra",
    "https://pokemondb.net/pokedex/phanpy",
    "https://pokemondb.net/pokedex/donphan",
    "https://pokemondb.net/pokedex/porygon2",
    "https://pokemondb.net/pokedex/stantler",
    "https://pokemondb.net/pokedex/smeargle",
    "https://pokemondb.net/pokedex/tyrogue",
    "https://pokemondb.net/pokedex/hitmontop",
    "https://pokemondb.net/pokedex/smoochum",
    "https://pokemondb.net/pokedex/elekid",
    "https://pokemondb.net/pokedex/magby",
    "https://pokemondb.net/pokedex/miltank",
    "https://pokemondb.net/pokedex/blissey",
    "https://pokemondb.net/pokedex/raikou",
    "https://pokemondb.net/pokedex/entei",
    "https://pokemondb.net/pokedex/suicune",
    "https://pokemondb.net/pokedex/larvitar",
    "https://pokemondb.net/pokedex/pupitar",
    "https://pokemondb.net/pokedex/tyranitar",
    "https://pokemondb.net/pokedex/lugia",
    "https://pokemondb.net/pokedex/ho-oh",
    "https://pokemondb.net/pokedex/celebi",
    "https://pokemondb.net/pokedex/treecko",
    "https://pokemondb.net/pokedex/grovyle",
    "https://pokemondb.net/pokedex/sceptile",
    "https://pokemondb.net/pokedex/torchic",
    "https://pokemondb.net/pokedex/combusken",
    "https://pokemondb.net/pokedex/blaziken",
    "https://pokemondb.net/pokedex/mudkip",
    "https://pokemondb.net/pokedex/marshtomp",
    "https://pokemondb.net/pokedex/swampert",
    "https://pokemondb.net/pokedex/poochyena",
    "https://pokemondb.net/pokedex/mightyena",
    "https://pokemondb.net/pokedex/zigzagoon",
    "https://pokemondb.net/pokedex/linoone",
    "https://pokemondb.net/pokedex/wurmple",
    "https://pokemondb.net/pokedex/silcoon",
    "https://pokemondb.net/pokedex/beautifly",
    "https://pokemondb.net/pokedex/cascoon",
    "https://pokemondb.net/pokedex/dustox",
    "https://pokemondb.net/pokedex/lotad",
    "https://pokemondb.net/pokedex/lombre",
    "https://pokemondb.net/pokedex/ludicolo",
    "https://pokemondb.net/pokedex/seedot",
    "https://pokemondb.net/pokedex/nuzleaf",
    "https://pokemondb.net/pokedex/shiftry",
    "https://pokemondb.net/pokedex/taillow",
    "https://pokemondb.net/pokedex/swellow",
    "https://pokemondb.net/pokedex/wingull",
    "https://pokemondb.net/pokedex/pelipper",
    "https://pokemondb.net/pokedex/ralts",
    "https://pokemondb.net/pokedex/kirlia",
    "https://pokemondb.net/pokedex/gardevoir",
    "https://pokemondb.net/pokedex/surskit",
    "https://pokemondb.net/pokedex/masquerain",
    "https://pokemondb.net/pokedex/shroomish",
    "https://pokemondb.net/pokedex/breloom",
    "https://pokemondb.net/pokedex/slakoth",
    "https://pokemondb.net/pokedex/vigoroth",
    "https://pokemondb.net/pokedex/slaking",
    "https://pokemondb.net/pokedex/nincada",
    "https://pokemondb.net/pokedex/ninjask",
    "https://pokemondb.net/pokedex/shedinja",
    "https://pokemondb.net/pokedex/whismur",
    "https://pokemondb.net/pokedex/loudred",
    "https://pokemondb.net/pokedex/exploud",
    "https://pokemondb.net/pokedex/makuhita",
    "https://pokemondb.net/pokedex/hariyama",
    "https://pokemondb.net/pokedex/azurill",
    "https://pokemondb.net/pokedex/nosepass",
    "https://pokemondb.net/pokedex/skitty",
    "https://pokemondb.net/pokedex/delcatty",
    "https://pokemondb.net/pokedex/sableye",
    "https://pokemondb.net/pokedex/mawile",
    "https://pokemondb.net/pokedex/aron",
    "https://pokemondb.net/pokedex/lairon",
    "https://pokemondb.net/pokedex/aggron",
    "https://pokemondb.net/pokedex/meditite",
    "https://pokemondb.net/pokedex/medicham",
    "https://pokemondb.net/pokedex/electrike",
    "https://pokemondb.net/pokedex/manectric",
    "https://pokemondb.net/pokedex/plusle",
    "https://pokemondb.net/pokedex/minun",
    "https://pokemondb.net/pokedex/volbeat",
    "https://pokemondb.net/pokedex/illumise",
    "https://pokemondb.net/pokedex/roselia",
    "https://pokemondb.net/pokedex/gulpin",
    "https://pokemondb.net/pokedex/swalot",
    "https://pokemondb.net/pokedex/carvanha",
    "https://pokemondb.net/pokedex/sharpedo",
    "https://pokemondb.net/pokedex/wailmer",
    "https://pokemondb.net/pokedex/wailord",
    "https://pokemondb.net/pokedex/numel",
    "https://pokemondb.net/pokedex/camerupt",
    "https://pokemondb.net/pokedex/torkoal",
    "https://pokemondb.net/pokedex/spoink",
    "https://pokemondb.net/pokedex/grumpig",
    "https://pokemondb.net/pokedex/spinda",
    "https://pokemondb.net/pokedex/trapinch",
    "https://pokemondb.net/pokedex/vibrava",
    "https://pokemondb.net/pokedex/flygon",
    "https://pokemondb.net/pokedex/cacnea",
    "https://pokemondb.net/pokedex/cacturne",
    "https://pokemondb.net/pokedex/swablu",
    "https://pokemondb.net/pokedex/altaria",
    "https://pokemondb.net/pokedex/zangoose",
    "https://pokemondb.net/pokedex/seviper",
    "https://pokemondb.net/pokedex/lunatone",
    "https://pokemondb.net/pokedex/solrock",
    "https://pokemondb.net/pokedex/barboach",
    "https://pokemondb.net/pokedex/whiscash",
    "https://pokemondb.net/pokedex/corphish",
    "https://pokemondb.net/pokedex/crawdaunt",
    ...
    "https://pokemondb.net/pokedex/anorith",
    "https://pokemondb.net/pokedex/armaldo",
    "https://pokemondb.net/pokedex/feebas",
    "https://pokemondb.net/pokedex/milotic",
    "https://pokemondb.net/pokedex/castform",
    "https://pokemondb.net/pokedex/kecleon",
    "https://pokemondb.net/pokedex/shuppet",
    "https://pokemondb.net/pokedex/banette",
    "https://pokemondb.net/pokedex/duskull",
    "https://pokemondb.net/pokedex/dusclops",
    "https://pokemondb.net/pokedex/tropius",
    "https://pokemondb.net/pokedex/chimecho",
    "https://pokemondb.net/pokedex/absol",
    "https://pokemondb.net/pokedex/wynaut",
    "https://pokemondb.net/pokedex/snorunt",
    "https://pokemondb.net/pokedex/glalie",
    "https://pokemondb.net/pokedex/spheal",
    "https://pokemondb.net/pokedex/sealeo",
    "https://pokemondb.net/pokedex/walrein",
    ...
    "https://pokemondb.net/pokedex/luvdisc",
    "https://pokemondb.net/pokedex/bagon",
    "https://pokemondb.net/pokedex/shelgon",
    "https://pokemondb.net/pokedex/salamence",
    "https://pokemondb.net/pokedex/beldum",
    "https://pokemondb.net/pokedex/metang",
    "https://pokemondb.net/pokedex/metagross",
    "https://pokemondb.net/pokedex/regirock",
    "https://pokemondb.net/pokedex/regice",
    "https://pokemondb.net/pokedex/registeel",
    "https://pokemondb.net/pokedex/latias",
    "https://pokemondb.net/pokedex/latios",
    ...
    "https://pokemondb.net/pokedex/grotle",
    "https://pokemondb.net/pokedex/torterra",
    "https://pokemondb.net/pokedex/chimchar",
    "https://pokemondb.net/pokedex/monferno",
    "https://pokemondb.net/pokedex/infernape",
    "https://pokemondb.net/pokedex/piplup",
    "https://pokemondb.net/pokedex/prinplup",
    "https://pokemondb.net/pokedex/empoleon",
    "https://pokemondb.net/pokedex/starly",
    "https://pokemondb.net/pokedex/staravia",
    "https://pokemondb.net/pokedex/staraptor",
    "https://pokemondb.net/pokedex/bidoof",
    "https://pokemondb.net/pokedex/bibarel",
    "https://pokemondb.net/pokedex/kricketot",
    "https://pokemondb.net/pokedex/kricketune",
    "https://pokemondb.net/pokedex/shinx",
    "https://pokemondb.net/pokedex/luxio",
    "https://pokemondb.net/pokedex/luxray",
    ...
    "https://pokemondb.net/pokedex/shieldon",
    "https://pokemondb.net/pokedex/bastiodon",
    "https://pokemondb.net/pokedex/burmy",
    "https://pokemondb.net/pokedex/wormadam",
    "https://pokemondb.net/pokedex/mothim",
    "https://pokemondb.net/pokedex/combee",
    "https://pokemondb.net/pokedex/vespiquen",
    "https://pokemondb.net/pokedex/pachirisu",
    "https://pokemondb.net/pokedex/buizel",
    "https://pokemondb.net/pokedex/floatzel",
    "https://pokemondb.net/pokedex/cherubi",
    "https://pokemondb.net/pokedex/cherrim",
    "https://pokemondb.net/pokedex/shellos",
    "https://pokemondb.net/pokedex/gastrodon",
    "https://pokemondb.net/pokedex/ambipom",
    "https://pokemondb.net/pokedex/drifloon",
    "https://pokemondb.net/pokedex/drifblim",
    "https://pokemondb.net/pokedex/buneary",
    "https://pokemondb.net/pokedex/lopunny",
    "https://pokemondb.net/pokedex/mismagius",
    "https://pokemondb.net/pokedex/honchkrow",
    "https://pokemondb.net/pokedex/glameow",
    "https://pokemondb.net/pokedex/purugly",
    "https://pokemondb.net/pokedex/chingling",
    "https://pokemondb.net/pokedex/stunky",
    "https://pokemondb.net/pokedex/skuntank",
    "https://pokemondb.net/pokedex/bronzor",
    "https://pokemondb.net/pokedex/bronzong",
    "https://pokemondb.net/pokedex/bonsly",
    "https://pokemondb.net/pokedex/mime-jr",
    "https://pokemondb.net/pokedex/happiny",
    "https://pokemondb.net/pokedex/chatot",
    "https://pokemondb.net/pokedex/spiritomb",
    "https://pokemondb.net/pokedex/gible",
    "https://pokemondb.net/pokedex/gabite",
    "https://pokemondb.net/pokedex/garchomp",
    "https://pokemondb.net/pokedex/munchlax",
    "https://pokemondb.net/pokedex/riolu",
    "https://pokemondb.net/pokedex/lucario",
    "https://pokemondb.net/pokedex/hippopotas",
    "https://pokemondb.net/pokedex/hippowdon",
    ...
    "https://pokemondb.net/pokedex/carnivine",
    "https://pokemondb.net/pokedex/finneon",
    "https://pokemondb.net/pokedex/lumineon",
    "https://pokemondb.net/pokedex/mantyke",
    "https://pokemondb.net/pokedex/snover",
    "https://pokemondb.net/pokedex/abomasnow",
    "https://pokemondb.net/pokedex/weavile",
    "https://pokemondb.net/pokedex/magnezone",
    "https://pokemondb.net/pokedex/lickilicky",
    "https://pokemondb.net/pokedex/rhyperior",
    "https://pokemondb.net/pokedex/tangrowth",
    "https://pokemondb.net/pokedex/electivire",
    "https://pokemondb.net/pokedex/magmortar",
    "https://pokemondb.net/pokedex/togekiss",
    "https://pokemondb.net/pokedex/yanmega",
    "https://pokemondb.net/pokedex/leafeon",
    "https://pokemondb.net/pokedex/glaceon",
    "https://pokemondb.net/pokedex/gliscor",
    "https://pokemondb.net/pokedex/mamoswine",
    "https://pokemondb.net/pokedex/porygon-z",
    "https://pokemondb.net/pokedex/gallade",
    "https://pokemondb.net/pokedex/probopass",
    "https://pokemondb.net/pokedex/dusknoir",
    "https://pokemondb.net/pokedex/froslass",
    "https://pokemondb.net/pokedex/rotom",
    "https://pokemondb.net/pokedex/uxie",
    "https://pokemondb.net/pokedex/mesprit",
    "https://pokemondb.net/pokedex/azelf",
    "https://pokemondb.net/pokedex/dialga",
    "https://pokemondb.net/pokedex/palkia",
    "https://pokemondb.net/pokedex/heatran",
    "https://pokemondb.net/pokedex/regigigas",
    "https://pokemondb.net/pokedex/giratina",
    "https://pokemondb.net/pokedex/cresselia",
    "https://pokemondb.net/pokedex/phione",
    "https://pokemondb.net/pokedex/manaphy",
    "https://pokemondb.net/pokedex/darkrai",
    "https://pokemondb.net/pokedex/shaymin",
    "https://pokemondb.net/pokedex/arceus",
    "https://pokemondb.net/pokedex/victini",
    "https://pokemondb.net/pokedex/snivy",
    "https://pokemondb.net/pokedex/servine",
    "https://pokemondb.net/pokedex/serperior",
    "https://pokemondb.net/pokedex/tepig",
    "https://pokemondb.net/pokedex/pignite",
    "https://pokemondb.net/pokedex/emboar",
    "https://pokemondb.net/pokedex/oshawott",
    "https://pokemondb.net/pokedex/dewott",
    "https://pokemondb.net/pokedex/samurott",
    "https://pokemondb.net/pokedex/patrat",
    "https://pokemondb.net/pokedex/watchog",
    "https://pokemondb.net/pokedex/lillipup",
    "https://pokemondb.net/pokedex/herdier",
    "https://pokemondb.net/pokedex/stoutland",
    "https://pokemondb.net/pokedex/purrloin",
    "https://pokemondb.net/pokedex/liepard",
    "https://pokemondb.net/pokedex/pansage",
    "https://pokemondb.net/pokedex/simisage",
    "https://pokemondb.net/pokedex/pansear",
    "https://pokemondb.net/pokedex/simisear",
    "https://pokemondb.net/pokedex/panpour",
    "https://pokemondb.net/pokedex/simipour",
    "https://pokemondb.net/pokedex/munna",
    "https://pokemondb.net/pokedex/musharna",
    "https://pokemondb.net/pokedex/pidove",
    "https://pokemondb.net/pokedex/tranquill",
    "https://pokemondb.net/pokedex/unfezant",
    "https://pokemondb.net/pokedex/blitzle",
    "https://pokemondb.net/pokedex/zebstrika",
    "https://pokemondb.net/pokedex/roggenrola",
    "https://pokemondb.net/pokedex/boldore",
    "https://pokemondb.net/pokedex/gigalith",
    "https://pokemondb.net/pokedex/woobat",
    "https://pokemondb.net/pokedex/swoobat",
    "https://pokemondb.net/pokedex/drilbur",
    "https://pokemondb.net/pokedex/excadrill",
    "https://pokemondb.net/pokedex/audino",
    "https://pokemondb.net/pokedex/timburr",
    "https://pokemondb.net/pokedex/gurdurr",
    "https://pokemondb.net/pokedex/conkeldurr",
    "https://pokemondb.net/pokedex/tympole",
    "https://pokemondb.net/pokedex/palpitoad",
    "https://pokemondb.net/pokedex/seismitoad",
    "https://pokemondb.net/pokedex/throh",
    "https://pokemondb.net/pokedex/sawk",
    "https://pokemondb.net/pokedex/sewaddle",
    "https://pokemondb.net/pokedex/swadloon",
    "https://pokemondb.net/pokedex/leavanny",
    "https://pokemondb.net/pokedex/venipede",
    "https://pokemondb.net/pokedex/whirlipede",
    "https://pokemondb.net/pokedex/scolipede",
    "https://pokemondb.net/pokedex/cottonee",
    "https://pokemondb.net/pokedex/whimsicott",
    "https://pokemondb.net/pokedex/petilil",
    "https://pokemondb.net/pokedex/lilligant",
    "https://pokemondb.net/pokedex/basculin",
    "https://pokemondb.net/pokedex/sandile",
    "https://pokemondb.net/pokedex/krokorok",
    "https://pokemondb.net/pokedex/krookodile",
    "https://pokemondb.net/pokedex/darumaka",
    "https://pokemondb.net/pokedex/darmanitan",
    ...
    "https://pokemondb.net/pokedex/sprigatito",
    "https://pokemondb.net/pokedex/floragato",
    "https://pokemondb.net/pokedex/meowscarada",
    "https://pokemondb.net/pokedex/fuecoco",
    "https://pokemondb.net/pokedex/crocalor",
    "https://pokemondb.net/pokedex/skeledirge",
    "https://pokemondb.net/pokedex/quaxly",
    "https://pokemondb.net/pokedex/quaxwell",
    "https://pokemondb.net/pokedex/quaquaval",
    "https://pokemondb.net/pokedex/lechonk",
    "https://pokemondb.net/pokedex/oinkologne",
    "https://pokemondb.net/pokedex/tarountula",
    "https://pokemondb.net/pokedex/spidops",
    "https://pokemondb.net/pokedex/nymble",
    "https://pokemondb.net/pokedex/lokix",
    "https://pokemondb.net/pokedex/pawmi",
    "https://pokemondb.net/pokedex/pawmo",
    "https://pokemondb.net/pokedex/pawmot",
    "https://pokemondb.net/pokedex/tandemaus",
    "https://pokemondb.net/pokedex/maushold",
    "https://pokemondb.net/pokedex/fidough",
    "https://pokemondb.net/pokedex/dachsbun",
    "https://pokemondb.net/pokedex/smoliv",
    "https://pokemondb.net/pokedex/dolliv",
    "https://pokemondb.net/pokedex/arboliva",
    "https://pokemondb.net/pokedex/squawkabilly",
    "https://pokemondb.net/pokedex/nacli",
    "https://pokemondb.net/pokedex/naclstack",
    "https://pokemondb.net/pokedex/garganacl",
    "https://pokemondb.net/pokedex/charcadet",
    "https://pokemondb.net/pokedex/armarouge",
    "https://pokemondb.net/pokedex/ceruledge",
    "https://pokemondb.net/pokedex/tadbulb",
    "https://pokemondb.net/pokedex/bellibolt",
    "https://pokemondb.net/pokedex/wattrel",
    "https://pokemondb.net/pokedex/kilowattrel",
    "https://pokemondb.net/pokedex/maschiff",
    "https://pokemondb.net/pokedex/mabosstiff",
    "https://pokemondb.net/pokedex/shroodle",
    "https://pokemondb.net/pokedex/grafaiai",
    "https://pokemondb.net/pokedex/bramblin",
    "https://pokemondb.net/pokedex/brambleghast",
    "https://pokemondb.net/pokedex/toedscool",
    "https://pokemondb.net/pokedex/toedscruel",
    "https://pokemondb.net/pokedex/klawf",
    "https://pokemondb.net/pokedex/capsakid",
    "https://pokemondb.net/pokedex/scovillain",
    "https://pokemondb.net/pokedex/rellor",
    "https://pokemondb.net/pokedex/rabsca",
    "https://pokemondb.net/pokedex/flittle",
    "https://pokemondb.net/pokedex/espathra",
    "https://pokemondb.net/pokedex/tinkatink",
    "https://pokemondb.net/pokedex/tinkatuff",
    "https://pokemondb.net/pokedex/tinkaton",
    "https://pokemondb.net/pokedex/wiglett",
    "https://pokemondb.net/pokedex/wugtrio",
    "https://pokemondb.net/pokedex/bombirdier",
    "https://pokemondb.net/pokedex/finizen",
    "https://pokemondb.net/pokedex/palafin",
    "https://pokemondb.net/pokedex/varoom",
    "https://pokemondb.net/pokedex/revavroom",
    "https://pokemondb.net/pokedex/cyclizar",
    "https://pokemondb.net/pokedex/orthworm",
    "https://pokemondb.net/pokedex/glimmet",
    "https://pokemondb.net/pokedex/glimmora",
    "https://pokemondb.net/pokedex/greavard",
    "https://pokemondb.net/pokedex/houndstone",
    "https://pokemondb.net/pokedex/flamigo",
    "https://pokemondb.net/pokedex/cetoddle",
    "https://pokemondb.net/pokedex/cetitan",
    "https://pokemondb.net/pokedex/veluza",
    "https://pokemondb.net/pokedex/dondozo",
    "https://pokemondb.net/pokedex/tatsugiri",
    "https://pokemondb.net/pokedex/annihilape",
    "https://pokemondb.net/pokedex/clodsire",
    "https://pokemondb.net/pokedex/farigiraf",
    "https://pokemondb.net/pokedex/dudunsparce",
    "https://pokemondb.net/pokedex/kingambit",
    "https://pokemondb.net/pokedex/great-tusk",
    "https://pokemondb.net/pokedex/scream-tail",
    "https://pokemondb.net/pokedex/brute-bonnet",
    "https://pokemondb.net/pokedex/flutter-mane",
    "https://pokemondb.net/pokedex/slither-wing",
    "https://pokemondb.net/pokedex/sandy-shocks",
    "https://pokemondb.net/pokedex/iron-treads",
    "https://pokemondb.net/pokedex/iron-bundle",
    "https://pokemondb.net/pokedex/iron-hands",
    "https://pokemondb.net/pokedex/iron-jugulis",
    "https://pokemondb.net/pokedex/iron-moth",
    "https://pokemondb.net/pokedex/iron-thorns",
    "https://pokemondb.net/pokedex/frigibax",
    "https://pokemondb.net/pokedex/arctibax",
    "https://pokemondb.net/pokedex/baxcalibur",
    "https://pokemondb.net/pokedex/gimmighoul",
    "https://pokemondb.net/pokedex/gholdengo",
    "https://pokemondb.net/pokedex/wo-chien",
    "https://pokemondb.net/pokedex/chien-pao",
    "https://pokemondb.net/pokedex/ting-lu",
    "https://pokemondb.net/pokedex/chi-yu",
    "https://pokemondb.net/pokedex/roaring-moon",
    "https://pokemondb.net/pokedex/iron-valiant",
    "https://pokemondb.net/pokedex/koraidon",
    "https://pokemondb.net/pokedex/miraidon",
    "https://pokemondb.net/pokedex/walking-wake",
    "https://pokemondb.net/pokedex/iron-leaves"
    # Adicione mais links aqui
]

# Diretório para salvar os arquivos JSON
output_dir = 'C:\Users\jorda\PycharmProjects\pythonProject5\Json pokemons'
